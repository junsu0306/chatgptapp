...
//                    phoneConnected = false;
    ...
    private Notification updateNotification() {
        ...
        PendingIntent action = PendingIntent.getActivity(context,
                ...
                PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE); // Flag indicating that if the described PendingIntent already exists, the current one should be canceled before generating a new one.
